...
class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(ItemViewHolder ViewHolder, int i) {
        ViewHolder.circle.setColor(context.getResources().getColor(Colorful.ThemeColor.values()[i].getColorPrimaryRes()));
    }

    @Override
    public ItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        final ItemViewHolder holder = new ItemViewHolder(LayoutInflater.from(context).inflate(R.layout.adapter_color_item, viewGroup, false));
